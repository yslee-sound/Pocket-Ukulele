 ...
 * 사용 예시:
 * ```kotlin
 * val repository = EmergencyPolicyRepository(supabase, "com.sweetapps.PocketUkulele")
...
class EmergencyPolicyRepository(
    ...
    private val appId: String = com.sweetapps.pocketukulele.BuildConfig.SUPABASE_APP_ID
) {
    /**
     * 활성 긴급 정책 조회
     *
